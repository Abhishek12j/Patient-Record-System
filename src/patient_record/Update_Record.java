...
public class Update_Record extends JFrame{
	...
	private void initialize() {
		...
		b1.setIcon(new ImageIcon("C:\\Users\\abhishek\\Desktop\\PatientRecord\\HMS ICON\\search.png"));
		...
		b2.setIcon(new ImageIcon("C:\\Users\\abhishek\\Desktop\\PatientRecord\\HMS ICON\\save-icon--1.png"));
		...
		b3.setIcon(new ImageIcon("C:\\Users\\abhishek\\Desktop\\PatientRecord\\HMS ICON\\Close.png"));
		b3.setFont(new Font("Times New Roman", Font.BOLD, 18));
		b3.setBounds(594, 763, 120, 25);
		frame.getContentPane().add(b3);
		
		JLabel lblNewLabel = new JLabel("New label");
		ImageIcon icon=new ImageIcon("C:\\Users\\abhishek\\Desktop\\PatientRecord\\texture.jpg");
